...
public abstract class MakeMountain {

	/**
	 * Creates a mountain with the center being located at the tile passed in.
	 * 
	 * @param mapData   - the map data which the mountain will be inserted into
	 * @param height    - the height the selected tile will be set to
	 * @param clickTile - the tile the mountain will be centered at
	 */

	public static void makeMountain(MapData mapData, int height, Tile clickTile) {
